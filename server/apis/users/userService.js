...
const { findAllUsers, updateUserById, findUserByEmail, createUser, getUserProfileStats } = require("./userRepo");
...
// New service function to get user profile statistics
const getUserProfile = async (userId) => {
    return await getUserProfileStats(userId);
};
